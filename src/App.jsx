...
//       <div className="rightSection">
//         {currentPage === 'login' && (
//           <Login setCurrentPage={setCurrentPage} showSignup={showSignup} />
//         )}
//         {currentPage === 'signup' && (
...
//           <ForgotPassword
//             isSecurityQuestionVisible={isSecurityQuestionVisible}
//             setIsSecurityQuestionVisible={setIsSecurityQuestionVisible}
//             showLogin={showLogin}
//           />
//         )}
//       </div>
...
import Signup from './artifact1/components/Signup';
import ForgotPassword from './artifact1/components/ForgotPassword';
import Addcourses from './artifact2/components/courses';  // Import your AddCourse component
    ...
    <Router>
      ...
      {/* <div className="container">
        ...
        <div className="rightSection">
            ...
            <Route path="/" element={currentPage === 'login' ? <Login setCurrentPage={setCurrentPage} showSignup={showSignup} /> : currentPage === 'signup' ? <Signup showLogin={showLogin} /> : <ForgotPassword isSecurityQuestionVisible={isSecurityQuestionVisible} setIsSecurityQuestionVisible={setIsSecurityQuestionVisible} showLogin={showLogin} />} />
      ...
      {/* Add a new route for /courses that renders AddCourse */}
